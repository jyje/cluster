...
This directory contains the vendored `portainer` Helm chart (version 245.0.0)
...
- First applied to 239.5.0 in #91/#112, carried forward here so the actively
  deployed version isn't left without the hook.
