...
| `master.fips.openssl`                                      | Configure OpenSSL FIPS mode: '', 'restricted', 'relaxed', 'off'. If empty (""), 'global.defaultFips' would be used                                                                                                              | `""`                     |
...
| `master.runtimeClassName`                                  | Name of the runtime class to be used by master pod(s)                                                                                                                                                                           | `""`                     |
...
| `master.service.sessionAffinityConfig`                     | Additional settings for the sessionAffinity. Ignored if `master.service.sessionAffinity` is `None`                                                                                                                              | `{}`                     |
...
| `replica.fips.openssl`                                      | Configure OpenSSL FIPS mode: '', 'restricted', 'relaxed', 'off'. If empty (""), 'global.defaultFips' would be used                                                                                                                | `""`                     |
...
| `replica.runtimeClassName`                                  | Name of the runtime class to be used by replica pod(s)                                                                                                                                                                            | `""`                     |
...
| `replica.service.sessionAffinityConfig`                     | Additional settings for the sessionAffinity. Ignored if `replica.service.sessionAffinity` is `None`                                                                                                                               | `{}`                     |
...
| `sentinel.fips.openssl`                                      | Configure OpenSSL FIPS mode: '', 'restricted', 'relaxed', 'off'. If empty (""), 'global.defaultFips' would be used                                                                                                                  | `""`                             |
...
| `sentinel.service.sessionAffinityConfig`                     | Additional settings for the sessionAffinity. Ignored if `sentinel.service.sessionAffinity` is `None`                                                                                                                                | `{}`                             |
...
| `sentinel.masterService.sessionAffinityConfig`               | Additional settings for the sessionAffinity. Ignored if `sentinel.masterService.sessionAffinity` is `None`                                                                                                                          | `{}`                             |
...
| `kubectl.fips.openssl`                                      | Configure OpenSSL FIPS mode: '', 'restricted', 'relaxed', 'off'. If empty (""), 'global.defaultFips' would be used                                                                                                                                    | `""`                                                              |
| `kubectl.fips.golang`                                       | Configure Golang FIPS mode: '', 'restricted', 'relaxed', 'off'. If empty (""), 'global.defaultFips' would be used                                                                                                                                     | `relaxed`                                                         |
...
| `sysctl.fips.openssl`                                       | Configure OpenSSL FIPS mode: '', 'restricted', 'relaxed', 'off'. If empty (""), 'global.defaultFips' would be used                                                                                                                                    | `""`                                                              |
