---
description: ensure all Helm charts have 'extraResources' support by patching templates/extra-resources.yaml and values.yaml
---

# Helm ExtraResources Patcher

This workflow ensures that all vendored top-level Helm charts in the repository support injecting arbitrary Kubernetes resources via the `extraResources` value. This is useful for adding related resources like `SealedSecrets` or `CloudNativePG Cluster` without modifying upstream chart templates.
